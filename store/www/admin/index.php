 ...
 <div id="header">
		...
		<div class="menu">
			<ul>
				...
				<li class="order"><a href="#" id="order">Заказы</a></li>
		...
		<div class="user">
			<a href="../index.php"><?=$_SESSION["User"]?></a> (<a href="/enter?out=1">Выход</a>)
		</div>
	</div>
	...
	<div id="content">
		<div class="data">
			<p style="text-align:center; margin:10% 40% 0 0; font-size:20pt; font-family:HelveticaRegular">Добро пожаловать<br>в панель администрирования системы!</p>
		</div>
	</div>
